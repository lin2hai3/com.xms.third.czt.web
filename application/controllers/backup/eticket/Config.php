...
//		);
        ...
        $data['blocks'] = array(
            ...
            array(
                'img' => $configs['index_block_6_img'],
                'url' => $configs['index_block_6_url'],
                'name' => $configs['index_block_6_name'], //'一票潮州',
                'wx_app' => $configs['index_block_6_wx_app'],
            ),
        );
    ...
    public function page_index_bak()
    {
        $data = array();
        $data['swiper'] = array(
            array(
...
//                'url' => '/pages/new/activity/a4',
        ...
        // https://linhai.666os.com/assets/images/20220208215048.jpg
        // /pages/new/category/index


        $data['ad'] = array(
            'status' => 'on',
            'img' => 'https://linhai.666os.com/assets/images/20220208215048.jpg',
            'url' => '/pages/new/category/index',
            'name' => '',
        );
    ...
    {
        $data = array(
            'bg_image' => 'https://linhai.666os.com/assets/images/20240205023716.jpg?v=1',
            'params' => array(
                'wx_appid' => 'wxf207735ea23c7cb5',
                'wx_path' => 'pages/singleTicketDetails/index?id=1718681804895084545',
                'extra_data' => array(
