...
//		);
//
//		$init_result = IRoomApp_helper::load($data);
...
//		return Util_helper::result($data);
		...
		$weixin_info = IRoomApp_helper::load($data);
		...
		$result_info = IRoomApp_helper::load($data);
		...
		$member_info = IRoomApp_helper::load($data);
		...
		if ($member_info['code'] == 0) {
			...
			$employee_info = IRoomApp_helper::load($data);
